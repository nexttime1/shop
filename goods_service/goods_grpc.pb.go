...
const (
	...
	Goods_GetBrand_FullMethodName             = "/Goods/GetBrand"
...
func (c *goodsClient) GetBrand(ctx context.Context, in *BrandRequest, opts ...grpc.CallOption) (*BrandResponse, error) {
	...
	err := c.cc.Invoke(ctx, Goods_GetBrand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Goods_GetBrand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Goods_GetBrand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	Pms_ListProductAttr_FullMethodName   = "/Pms/ListProductAttr"
	Pms_CreateProductAttr_FullMethodName = "/Pms/CreateProductAttr"
	Pms_ListSkuStock_FullMethodName      = "/Pms/ListSkuStock"
	Pms_CreateSkuStock_FullMethodName    = "/Pms/CreateSkuStock"
)
...
func (c *pmsClient) ListProductAttr(ctx context.Context, in *ProductAttrListRequest, opts ...grpc.CallOption) (*ProductAttrListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductAttrListResponse)
	err := c.cc.Invoke(ctx, Pms_ListProductAttr_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pmsClient) CreateProductAttr(ctx context.Context, in *ProductAttrItem, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Pms_CreateProductAttr_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pmsClient) ListSkuStock(ctx context.Context, in *SkuStockListRequest, opts ...grpc.CallOption) (*SkuStockListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SkuStockListResponse)
	err := c.cc.Invoke(ctx, Pms_ListSkuStock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pmsClient) CreateSkuStock(ctx context.Context, in *SkuStockItem, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Pms_CreateSkuStock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPmsServer) ListProductAttr(context.Context, *ProductAttrListRequest) (*ProductAttrListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListProductAttr not implemented")
}
func (UnimplementedPmsServer) CreateProductAttr(context.Context, *ProductAttrItem) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateProductAttr not implemented")
}
func (UnimplementedPmsServer) ListSkuStock(context.Context, *SkuStockListRequest) (*SkuStockListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSkuStock not implemented")
}
func (UnimplementedPmsServer) CreateSkuStock(context.Context, *SkuStockItem) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateSkuStock not implemented")
}
...
func RegisterPmsServer(s grpc.ServiceRegistrar, srv PmsServer) {
	// If the following call panics, it indicates UnimplementedPmsServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func _Pms_ListProductAttr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProductAttrListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PmsServer).ListProductAttr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pms_ListProductAttr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PmsServer).ListProductAttr(ctx, req.(*ProductAttrListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Pms_CreateProductAttr_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProductAttrItem)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PmsServer).CreateProductAttr(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pms_CreateProductAttr_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PmsServer).CreateProductAttr(ctx, req.(*ProductAttrItem))
	}
	return interceptor(ctx, in, info, handler)
}

func _Pms_ListSkuStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SkuStockListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PmsServer).ListSkuStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pms_ListSkuStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PmsServer).ListSkuStock(ctx, req.(*SkuStockListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Pms_CreateSkuStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SkuStockItem)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PmsServer).CreateSkuStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pms_CreateSkuStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PmsServer).CreateSkuStock(ctx, req.(*SkuStockItem))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Pms_ListProductAttr_Handler,
		},
		{
			MethodName: "CreateProductAttr",
			Handler:    _Pms_CreateProductAttr_Handler,
		},
		{
			MethodName: "ListSkuStock",
			Handler:    _Pms_ListSkuStock_Handler,
		},
		{
			MethodName: "CreateSkuStock",
			Handler:    _Pms_CreateSkuStock_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/goods.proto",
