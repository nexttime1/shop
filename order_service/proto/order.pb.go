...
type OrderStatus struct {
	...
	OrderSn string `protobuf:"bytes,2,opt,name=orderSn,proto3" json:"orderSn,omitempty"` // 订单编号（唯一标识）
	Status  string `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`   // 目标状态（PAYING/TRADE_SUCCESS/SHIPPED等）
}
...
type CartItemRequest struct {
	...
	Id         int32   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                  // 购物车项ID（修改时必填，新增时不传）
	...
	GoodsPrice float32 `protobuf:"fixed32,6,opt,name=goodsPrice,proto3" json:"goodsPrice,omitempty"` // 商品单价（替换float为double，提升精度）
	Nums       int32   `protobuf:"varint,7,opt,name=nums,proto3" json:"nums,omitempty"`              // 商品数量
	Checked    *bool   `protobuf:"varint,8,opt,name=checked,proto3,oneof" json:"checked,omitempty"`  // 是否勾选（结算标识）
}
...
type OrderInfoResponse struct {
	...
	PayType string  `protobuf:"bytes,4,opt,name=payType,proto3" json:"payType,omitempty"` // 支付方式（alipay/wechat）
	Status  string  `protobuf:"bytes,5,opt,name=status,proto3" json:"status,omitempty"`   // 订单状态
	Post    string  `protobuf:"bytes,6,opt,name=post,proto3" json:"post,omitempty"`       // 物流单号
	...
	Name    string  `protobuf:"bytes,9,opt,name=name,proto3" json:"name,omitempty"`       // 签收人姓名
	Mobile  string  `protobuf:"bytes,10,opt,name=mobile,proto3" json:"mobile,omitempty"`  // 签收人手机号
}
...
type ShopCartInfoResponse struct {
	...
	Checked *bool `protobuf:"varint,5,opt,name=checked,proto3,oneof" json:"checked,omitempty"` // 是否勾选
}
...
type OrderItemResponse struct {
	...
	Id         int32   `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`                  // 订单商品项ID
...
type OrderFilterRequest struct {
	...
	PageNum  int32 `protobuf:"varint,2,opt,name=pageNum,proto3" json:"pageNum,omitempty"`   // 页码（修正原pages命名，符合行业惯例）
	PageSize int32 `protobuf:"varint,3,opt,name=pageSize,proto3" json:"pageSize,omitempty"` // 每页条数（修正原pagePerNums命名）
}
...
func (x *OrderFilterRequest) GetPageNum() int32 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
type OrderListResponse struct {
	...
	Data  []*OrderInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`    // 订单列表数据
}
...
var file_order_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x48, 0x0a, 0x14, 0x41, 0x6c, 0x69, 0x70, 0x61, 0x79,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18,
	0x0a, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x6e, 0x12, 0x16, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74,
	...
	0x73, 0x22, 0xf0, 0x01, 0x0a, 0x0f, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x65,
	...
	0x01, 0x28, 0x05, 0x52, 0x04, 0x6e, 0x75, 0x6d, 0x73, 0x12, 0x1d, 0x0a, 0x07, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x65, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x07, 0x63, 0x68,
	0x65, 0x63, 0x6b, 0x65, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x63, 0x68, 0x65,
	...
	0x65, 0x22, 0x97, 0x01, 0x0a, 0x14, 0x53, 0x68, 0x6f, 0x70, 0x43, 0x61, 0x72, 0x74, 0x49, 0x6e,
	...
	0x12, 0x1d, 0x0a, 0x07, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x08, 0x48, 0x00, 0x52, 0x07, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64, 0x88, 0x01, 0x01, 0x42,
	0x0a, 0x0a, 0x08, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x65, 0x64, 0x22, 0xc9, 0x01, 0x0a, 0x11,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x28, 0x0a, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x22, 0x62,
	...
	0x7a, 0x65, 0x22, 0x51, 0x0a, 0x11, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52,
...
func (c *orderClient) OrderDetailByOrderSn(ctx context.Context, in *AlipayOrderSnRequest, opts ...grpc.CallOption) (*OrderInfoDetailResponse, error) {
	out := new(OrderInfoDetailResponse)
	err := c.cc.Invoke(ctx, "/Order/OrderDetailByOrderSn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedOrderServer) OrderDetailByOrderSn(context.Context, *AlipayOrderSnRequest) (*OrderInfoDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderDetailByOrderSn not implemented")
}
...
func _Order_OrderDetailByOrderSn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Order/OrderDetailByOrderSn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
